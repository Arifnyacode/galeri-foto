        ...
        <div class="container-fluid">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <li><a class="dropdown-item" href="#">Something else here</a></li>
                ...
                <a class="btn btn-outline-success" type="submit" href="form-login.php">Logout</a>
            </div>
        </div>
    </nav>
    <div class="container">
        <div class="row">
            <ul class="nav justify-content-center">
                <li class="nav-item">
                    <a href="form-tambahfoto.php" class="nav-link">tambah foto</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="#">Semua Foto</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">Album A</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#">Album B</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link disabled" href="#" tabindex="-1" aria-disabled="true">Album dst</a>
                </li>
            </ul>
